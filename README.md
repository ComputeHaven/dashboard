...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [ComputeHaven](https://github.com/ComputeHaven) open-source ecosystem.
...
The `dashboard` application is the web frontend for ComputeHaven, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/ComputeHaven/dashboard
cd dashboard
npm install
```
